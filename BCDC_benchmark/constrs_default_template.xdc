...
#set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports {hours_phys}]
#set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports {minutes_phys}]
